...
const config = {
    ...
    rules: [
      ...
      },
      {
        ...
        use: [
          ...
          MiniCssExtractPlugin.loader, 'css-loader', 'sass-loader', 'postcss-loader' // npm install --save-dev sass-loader node-sass postcss-loader postcss
        ]
      },
      {
        test: /\.js$/,
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({ // more options> https://github.com/jantimon/html-webpack-plugin
      title: 'Nepmesek',
      filename: 'nepmesek.html',
      template: './src/nepmesek.html',
      meta: {
        viewport: 'width=device-width, initial-scale=1'
      }
    }),
